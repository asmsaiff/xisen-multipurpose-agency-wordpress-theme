 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Xisen for publication on WordPress.org
...
add_action( 'tgmpa_register', 'xisen_register_required_plugins' );
 ...
 */
function xisen_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			...
			'version'            => '4.2.14', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
	 ...
	 */
	$config = array(
		'id'           => 'xisen',                 // Unique ID for hashing notices for multiple instances of TGMPA.
